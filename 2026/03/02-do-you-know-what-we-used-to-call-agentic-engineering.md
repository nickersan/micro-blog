...
The problem wasn't purely the process, it was the separation of responsibilities.

The familiarity you need to have with the problem that you're trying to solve with software, in order to write that software, is deep.  Trying to design the solution, on paper (or
